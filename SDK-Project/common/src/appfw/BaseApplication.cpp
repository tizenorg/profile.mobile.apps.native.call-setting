...
namespace appfw {
	...
	int BaseApplication::appRun(int argc, char* argv[])
	{
	...
	void BaseApplication::appTerminate()
	{
		ui_app_exit();
	}
	...
	gui::ViewManager &BaseApplication::getViewManager()
	{
	...
	{
		bindtextdomain(TEXT_DOMAIN, getLocaleDir().c_str());
	...
	void BaseApplication::AppTerminateCb()
	{
		...
		gui::ViewManager::destroy(m_pViewManager);
	}
