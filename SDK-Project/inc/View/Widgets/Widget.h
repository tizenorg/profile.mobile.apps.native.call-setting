...
namespace View { namespace Widgets {
	...
	public:
		...
		template <class WidgetClass, typename... TYPE_ARGS>
		static WidgetClass* create(Widget *parent, TYPE_ARGS... ARGS);
	...
	template <class WidgetClass, typename... TYPE_ARGS>
	WidgetClass* Widget::create(Widget *parent, TYPE_ARGS... ARGS)
	{
		RETVM_IF (!parent || !parent->getEvasObject(), nullptr, "Parrent is invalid!");
