...
namespace Model { namespace Settings {
	...
	public:
		...
		virtual void removePropertyListener(int listenerId) = 0;
		virtual void removeAllListeners() = 0;

		virtual ResultCode setIntProperty(IntKey key, int &keyValue) = 0;
		virtual ResultCode getIntProperty(IntKey key, int &keyValue) = 0;
		virtual ResultCode setBoolProperty(BoolKey key, bool &keyValue) = 0;
		virtual ResultCode getBoolProperty(BoolKey key, bool &keyValue) = 0;
		virtual ResultCode setStringProperty(StringKey key, std::string &keyValue) = 0;
		virtual ResultCode getStringProperty(StringKey key, std::string &keyValue) = 0;
	};
} }
