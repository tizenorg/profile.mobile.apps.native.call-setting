...
namespace Model { namespace Settings {
	...
	public:
		SettingsManager();
		~SettingsManager();
		ResultCode addPropertyListener(BoolKey key, PropertyListener<bool> *listener);
		ResultCode addPropertyListener(IntKey key, PropertyListener<int> *listener);
		ResultCode addPropertyListener(StringKey key, PropertyListener<std::string> *listener);
		void removePropertyListener(PropertyListener<bool> *listener);
		void removePropertyListener(PropertyListener<int> *listener);
		void removePropertyListener(PropertyListener<std::string> *listener);
		ResultCode setIntProperty(IntKey key, int value);
		ResultCode getIntProperty(IntKey key, int &value);
		ResultCode setBoolProperty(BoolKey key, bool value);
		ResultCode getBoolProperty(BoolKey key, bool &value);
		ResultCode setStringProperty(StringKey key, const std::string &value);
		ResultCode getStringProperty(StringKey key, std::string &value);
