...
namespace CallSettings { namespace Controller {
	...
	MainViewController::MainViewController (Application &appCore, NotifyHandler handler) :
	...
	bool MainViewController::initialize()
	{
		...
		m_pMainView = ViewManager::pushView<View::MainView>(m_appCore.getViewManager(), true);
	...
	void MainViewController::onCallAnsweringClick()
	{
		...
		m_pAnswerCallController = ViewController::create<Controller::AnswerViewController>(m_appCore,
