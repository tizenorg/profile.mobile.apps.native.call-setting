...
namespace CallSettings { namespace Model {
	...
	SettingResultCode SettingsManager::addPropertyHandler(IntKey key, NotiHandler handler)
	{
		return addHandlerImpl(key, handler);
	}

	SettingResultCode SettingsManager::addPropertyHandler(BoolKey key, NotiHandler handler)
	{
		return addHandlerImpl(key, handler);
	}

	SettingResultCode SettingsManager::addPropertyHandler(StringKey key, NotiHandler handler)
	{
		return addHandlerImpl(key, handler);
	}
	...
	SettingResultCode SettingsManager::addHandlerImpl(int key, NotiHandler handler)
	{
