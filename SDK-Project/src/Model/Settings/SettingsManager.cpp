...
namespace CallSettings { namespace Model {
	...
	SettingResultCode SettingsManager::setProperty(IntKey key, int value)
	{
	...
	SettingResultCode SettingsManager::getProperty(IntKey key, int &value)
	{
		const char *vconfKey = convertPropertyKeyToVconfKey(key);
		RETVM_IF(!vconfKey, SETTINGS_RES_FAIL_KEY_UNKNOWN, "Key was not found");
	...
	SettingResultCode SettingsManager::setProperty(BoolKey key, bool value)
	{
		const char *vconfKey = convertPropertyKeyToVconfKey(key);
		RETVM_IF(!vconfKey, SETTINGS_RES_FAIL_KEY_UNKNOWN, "Key was not found");
	...
	SettingResultCode SettingsManager::getProperty(BoolKey key, bool &value)
	{
		const char *vconfKey = convertPropertyKeyToVconfKey(key);
		RETVM_IF(!vconfKey, SETTINGS_RES_FAIL_KEY_UNKNOWN, "Key was not found");
	...
	SettingResultCode SettingsManager::setProperty(StringKey key, const std::string &value)
	{
		const char *vconfKey = convertPropertyKeyToVconfKey(key);
		RETVM_IF(!vconfKey, SETTINGS_RES_FAIL_KEY_UNKNOWN, "Key was not found");
	...
	SettingResultCode SettingsManager::getProperty(StringKey key, std::string &value)
	{
		const char *vconfKey = convertPropertyKeyToVconfKey(key);
		RETVM_IF(!vconfKey, SETTINGS_RES_FAIL_KEY_UNKNOWN, "Key was not found");
	...
	SettingResultCode SettingsManager::getValueByVconfKey(const char *vconfKey, int &value)
	{
		int vconfValue = 0;
	...
	SettingResultCode SettingsManager::getValueByVconfKey(const char *vconfKey, bool &value)
	{
		int vconfValue = 0;
	...
	SettingResultCode SettingsManager::getValueByVconfKey(const char *vconfKey, std::string &value)
	{
	...
	SettingResultCode SettingsManager::registerVconfKeyChangeCb(int key)
	{
		const char *vconfKey = convertPropertyKeyToVconfKey(key);
		RETVM_IF(!vconfKey, SETTINGS_RES_FAIL_KEY_UNKNOWN, "Key was not found");
	...
	SettingResultCode SettingsManager::addPropertyHandler(IntKey key, NotifyHandler handler)
	{
		return addHandlerImpl(key, handler);
	}

	SettingResultCode SettingsManager::addPropertyHandler(BoolKey key, NotifyHandler handler)
	{
		return addHandlerImpl(key, handler);
	}

	SettingResultCode SettingsManager::addPropertyHandler(StringKey key, NotifyHandler handler)
	{
		return addHandlerImpl(key, handler);
	}
	...
	SettingResultCode SettingsManager::addHandlerImpl(int key, NotifyHandler handler)
	{
		auto it = m_handlersMap.find(key);
		if (it == m_handlersMap.end()) {
			SettingResultCode res = registerVconfKeyChangeCb(key);
