...
namespace Widgets {
	...
	bool Checkbox::initialize(const Widget &parent, CheckboxType type)
	{
		...
		evas_object_smart_callback_add(m_pEvasObject, "changed", makeEvasSmartCb(Checkbox, &Checkbox::onChecked), this);
	...
	void Checkbox::setCheckHandler(NotiHandler handler)
	{
