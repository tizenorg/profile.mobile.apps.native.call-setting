...
%description
The application provides functionality to change specific call settings, like set call-reject messages, turn on/off Home/Power keys support and call forwarding/waiting options.
