...
#include "appfw/SystemEventManager.h"
...
namespace appfw {
	...
	void SystemEventManager::initialize()
	{
		ui_app_add_event_handler(&m_pLanguageChange_h, APP_EVENT_LANGUAGE_CHANGED,
				AppEventCb::make<SystemEventManager, &SystemEventManager::onLanguageChanged>(), this);

		ui_app_add_event_handler(&m_pRegionFmtChange_h, APP_EVENT_REGION_FORMAT_CHANGED,
				AppEventCb::make<SystemEventManager, &SystemEventManager::onRegionFormatChanged>(), this);
	}
	...
	{
		DBG("System Region format changes");
