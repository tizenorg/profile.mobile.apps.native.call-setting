...
static const char *cst_str[] = {
	...
	N_("IDS_COM_BODY_ENTER_PASSWORD"),
	N_("IDS_CST_SK3_CHANGE_PASSWORD"),
	N_("IDS_CST_BODY_CURRENT_PASSWORD"),
	N_("IDS_CST_BODY_NEW_PASSWORD"),
	N_("IDS_CST_POP_CONFIRM_PASSWORD"),
	N_("IDS_ST_BODY_INCORRECT_PASSWORD_TRY_AGAIN"),
	N_("IDS_CST_POP_PASSWORD_CHANGED"),
#endif  /* _CALL_SET_BARRING_SUPPORT */
#ifdef _CALL_SET_FDN_SUPPORT
	N_("IDS_PB_OPT_FDN_CONTACT"),
	N_("IDS_COM_BODY_READING_FROM_SIM_CARD"),
	N_("IDS_CALL_POP_FDN_NOT_SUPPORTED"),
	N_("IDS_CST_BODY_FIXED_DIALLING_NUMBERS"),
	N_("IDS_COM_OPT_CONTACT_FDN_CONTACTS"),
	N_("IDS_ST_BODY_FIXED_DIALLING_MODE"),
	N_("IDS_ST_BODY_PIN2"),
	N_("IDS_ST_BODY_PUK2"),
	N_("IDS_ST_POP_PIN2_BLOCKED"),
	N_("IDS_ST_BODY_PUK2_BLOCKED"),
	N_("IDS_ST_POP_PIN2_UNBLOCKED"),
	N_("IDS_ST_POP_INCORRECT_PIN2"),
	N_("IDS_ST_POP_INCORRECT_PIN21_ATTEMPT_LEFT"),
	N_("IDS_ST_POP_INCORRECT_PIN22_ATTEMPTS_LEFT"),
	N_("IDS_ST_BODY_NEW_PIN2"),
	N_("IDS_ST_BODY_CONFIRM_NEW_PIN2"),
	N_("IDS_ST_BODY_1_ATTTEMPT_LEFT"),
	N_("IDS_ST_POP_PD_ATTEMPTS_LEFT"),
	N_("IDS_CST_BODY_UNBLOCK_PIN2"),
	N_("IDS_CST_POP_INCORRECT_PIN2_SIM_CARD_IS_LOCKED_ENTER_PUK2_TO_UNLOCK_IT"),
	N_("IDS_ST_BODY_CHANGE_PIN2"),
	N_("IDS_CST_NPBODY_NO_CONTACTS"),
	N_("IDS_CST_BODY_AFTER_YOU_ADD_CONTACTS_FDN_CONTACTS_WILL_BE_SHOWN_HERE"),
	N_("IDS_CST_HEADER_ENTER_PIN2"),
#endif  /* _CALL_SET_FDN_SUPPORT */
	N_("IDS_VCALL_BODY_BT_HEADSET"),
/*	N_("IDS_CALL_BUTTON_RECEIVER"), */
	...
	N_("IDS_PB_POP_FDN_MODE_ACTIVATED"),
